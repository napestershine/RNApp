...
import { retrieve, reset } from '../../actions/city/show';
import { del, loading, error } from '../../actions/city/delete';
import { list } from '../../actions/city/list';
    ...
    return (
        <View style={styles.actionStyle}>
          <SocialIcon
              ...
              type='plus-circle'
              iconColor='#3faab4'
              onPress={() => Actions.cityCreate()}
          />
          <SocialIcon
              iconSize={34}
              type='edit'
              iconColor='#3faab4'
              onPress={() => Actions.cityUpdate({id})}
          />
          <SocialIcon
              iconSize={34}
              type='minus-circle'
...
const mapStateToProps = (state) => {
  return {
    error: state.city.show.error,
    loading: state.city.show.loading,
    retrieved: state.city.show.retrieved,
    deleteError: state.city.del.error,
    deleteLoading: state.city.del.loading,
