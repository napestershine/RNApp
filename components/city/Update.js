...
import { success } from '../../actions/city/create';
import { retrieve, update, reset } from '../../actions/city/update';
import { loading, error } from '../../actions/city/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.city.update.retrieveError,
  retrieveLoading: state.city.update.retrieveLoading,
  updateError: state.city.update.updateError,
  updateLoading: state.city.update.updateLoading,
  created: state.city.create.created,
  deleted: state.city.del.deleted,
  retrieved: state.city.update.retrieved,
  updated: state.city.update.updated,
});
