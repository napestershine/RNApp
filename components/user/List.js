        ...
        <ListItem
            ...
            subtitle={
              <View>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>middleName: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['middleName']}</Text>
                </View>
                <View style={viewList}>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>avatar: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['avatar']}</Text>
                </View>
                <View style={viewList}>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>lastIP: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['lastIP']}</Text>
                </View>
                <View style={viewList}>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>isBlocked: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['isBlocked']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>blockedBy: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['blockedBy']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>activatedBy: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['activatedBy']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>dateOfBirth: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['dateOfBirth']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>remark: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['remark']}</Text>
                </View>
                <View style={viewList}>
