          ...
          <ScrollView>
            ...
            <Card title="User">
              <List title="title">
                ...
                {Show.renderRow('middleName', item['middleName'])}
                {Show.renderRow('lastName', item['lastName'])}
                {Show.renderRow('phone', item['phone'])}
                {Show.renderRow('avatar', item['avatar'])}
                ...
                {Show.renderRow('lastIP', item['lastIP'])}
                {Show.renderRow('isActive', item['isActive'])}
                {Show.renderRow('isBlocked', item['isBlocked'])}
                {Show.renderRow('blockedBy', item['blockedBy'])}
                {Show.renderRow('activatedBy', item['activatedBy'])}
                {Show.renderRow('dateOfBirth', item['dateOfBirth'])}
                {Show.renderRow('remark', item['remark'])}
