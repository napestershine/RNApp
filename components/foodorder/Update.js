...
import { success } from '../../actions/foodorder/create';
import { retrieve, update, reset } from '../../actions/foodorder/update';
import { loading, error } from '../../actions/foodorder/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.foodorder.update.retrieveError,
  retrieveLoading: state.foodorder.update.retrieveLoading,
  updateError: state.foodorder.update.updateError,
  updateLoading: state.foodorder.update.updateLoading,
  created: state.foodorder.create.created,
  deleted: state.foodorder.del.deleted,
  retrieved: state.foodorder.update.retrieved,
  updated: state.foodorder.update.updated,
});
