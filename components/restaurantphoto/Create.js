...
import { create, loading, error, reset } from '../../actions/restaurantphoto/create';
...
const mapStateToProps = state => {
  const {created, error, loading} = state.restaurantphoto.create;
