...
import { success } from '../../actions/restaurantphoto/create';
import { retrieve, update, reset } from '../../actions/restaurantphoto/update';
import { loading, error } from '../../actions/restaurantphoto/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.restaurantphoto.update.retrieveError,
  retrieveLoading: state.restaurantphoto.update.retrieveLoading,
  updateError: state.restaurantphoto.update.updateError,
  updateLoading: state.restaurantphoto.update.updateLoading,
  created: state.restaurantphoto.create.created,
  deleted: state.restaurantphoto.del.deleted,
  retrieved: state.restaurantphoto.update.retrieved,
  updated: state.restaurantphoto.update.updated,
});
