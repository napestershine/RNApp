    ...
    return (
      <View>
        ...
        <FormInput containerStyle={ {flexDirection:'row'} }
                   ...
                   id={`restaurantphoto_${data.input.name}`}
                   multiline={true}
  ...
  render() {
    ...
    return (
      <View style={ {backgroundColor: 'white', paddingBottom: 20} }>
        <Field component={this.renderField} name="path" type="text"
          placeholder="" />
        <Field component={this.renderField} name="bigThumbnailPath" type="text"
          placeholder="" />
        <Field component={this.renderField} name="smallThumbnailPath" type="text"
          placeholder="" />
