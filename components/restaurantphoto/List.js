...
import { list, reset } from '../../actions/restaurantphoto/list';
import { success } from '../../actions/restaurantphoto/delete';
...
class ListComponent extends Component {
  ...
  static show(id) {
    Actions.restaurantphotoShow({id});
  }
        ...
        <ListItem
            ...
            subtitle={
              <View>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>path: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['path']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>bigThumbnailPath: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['bigThumbnailPath']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>smallThumbnailPath: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['smallThumbnailPath']}</Text>
                </View>
                <View style={viewList}>
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.restaurantphoto.list;
