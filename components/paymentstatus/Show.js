...
import { retrieve, reset } from '../../actions/paymentstatus/show';
import { del, loading, error } from '../../actions/paymentstatus/delete';
import { list } from '../../actions/paymentstatus/list';
    ...
    return (
        <View style={styles.actionStyle}>
          <SocialIcon
              ...
              type='plus-circle'
              iconColor='#3faab4'
              onPress={() => Actions.paymentstatusCreate()}
          />
          <SocialIcon
              iconSize={34}
              type='edit'
              iconColor='#3faab4'
              onPress={() => Actions.paymentstatusUpdate({id})}
          />
          <SocialIcon
              iconSize={34}
              type='minus-circle'
...
const mapStateToProps = (state) => {
  return {
    error: state.paymentstatus.show.error,
    loading: state.paymentstatus.show.loading,
    retrieved: state.paymentstatus.show.retrieved,
    deleteError: state.paymentstatus.del.error,
    deleteLoading: state.paymentstatus.del.loading,
