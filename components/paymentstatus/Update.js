...
import { success } from '../../actions/paymentstatus/create';
import { retrieve, update, reset } from '../../actions/paymentstatus/update';
import { loading, error } from '../../actions/paymentstatus/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.paymentstatus.update.retrieveError,
  retrieveLoading: state.paymentstatus.update.retrieveLoading,
  updateError: state.paymentstatus.update.updateError,
  updateLoading: state.paymentstatus.update.updateLoading,
  created: state.paymentstatus.create.created,
  deleted: state.paymentstatus.del.deleted,
  retrieved: state.paymentstatus.update.retrieved,
  updated: state.paymentstatus.update.updated,
});
