...
import { list, reset } from '../../actions/paymentstatus/list';
import { success } from '../../actions/paymentstatus/delete';
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.paymentstatus.list;
