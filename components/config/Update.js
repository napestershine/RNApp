...
import { success } from '../../actions/config/create';
import { retrieve, update, reset } from '../../actions/config/update';
import { loading, error } from '../../actions/config/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.config.update.retrieveError,
  retrieveLoading: state.config.update.retrieveLoading,
  updateError: state.config.update.updateError,
  updateLoading: state.config.update.updateLoading,
  created: state.config.create.created,
  deleted: state.config.del.deleted,
  retrieved: state.config.update.retrieved,
  updated: state.config.update.updated,
});
