...
import { success } from '../../actions/cuisine/create';
import { retrieve, update, reset } from '../../actions/cuisine/update';
import { loading, error } from '../../actions/cuisine/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.cuisine.update.retrieveError,
  retrieveLoading: state.cuisine.update.retrieveLoading,
  updateError: state.cuisine.update.updateError,
  updateLoading: state.cuisine.update.updateLoading,
  created: state.cuisine.create.created,
  deleted: state.cuisine.del.deleted,
  retrieved: state.cuisine.update.retrieved,
  updated: state.cuisine.update.updated,
});
