...
import {list, reset} from '../../actions/cuisine/list';
import {success} from '../../actions/cuisine/delete';
...
const mapStateToProps = state => {
    const {retrieved, error, loading, eventSource} = state.cuisine.list;
