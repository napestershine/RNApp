...
import { retrieve, reset } from '../../actions/cuisine/show';
import { del, loading, error } from '../../actions/cuisine/delete';
import { list } from '../../actions/cuisine/list';
    ...
    return (
        <View style={styles.actionStyle}>
          <SocialIcon
              ...
              type='plus-circle'
              iconColor='#3faab4'
              onPress={() => Actions.cuisineCreate()}
          />
          <SocialIcon
              iconSize={34}
              type='edit'
              iconColor='#3faab4'
              onPress={() => Actions.cuisineUpdate({id})}
          />
          <SocialIcon
              iconSize={34}
              type='minus-circle'
          ...
          <ScrollView>
            ...
            <Card title="Cuisine">
              <List title="title">
                ...
                {Show.renderRow('imageFile', item['imageFile'])}
...
const mapStateToProps = (state) => {
  return {
    error: state.cuisine.show.error,
    loading: state.cuisine.show.loading,
    retrieved: state.cuisine.show.retrieved,
    deleteError: state.cuisine.del.error,
    deleteLoading: state.cuisine.del.loading,
    deleted: state.cuisine.del.deleted,
  };
};
