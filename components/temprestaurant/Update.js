...
import { success } from '../../actions/temprestaurant/create';
import { retrieve, update, reset } from '../../actions/temprestaurant/update';
import { loading, error } from '../../actions/temprestaurant/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.temprestaurant.update.retrieveError,
  retrieveLoading: state.temprestaurant.update.retrieveLoading,
  updateError: state.temprestaurant.update.updateError,
  updateLoading: state.temprestaurant.update.updateLoading,
  created: state.temprestaurant.create.created,
  deleted: state.temprestaurant.del.deleted,
  retrieved: state.temprestaurant.update.retrieved,
  updated: state.temprestaurant.update.updated,
});
