...
import { list, reset } from '../../actions/temprestaurant/list';
import { success } from '../../actions/temprestaurant/delete';
        ...
        <ListItem
            ...
            subtitle={
              <View>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>restaurantName: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['restaurantName']}</Text>
                </View>
                <View style={viewList}>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>address: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['address']}</Text>
                </View>
                <View style={viewList}>
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.temprestaurant.list;
