...
import { retrieve, reset } from '../../actions/reviewphoto/show';
import { del, loading, error } from '../../actions/reviewphoto/delete';
import { list } from '../../actions/reviewphoto/list';
    ...
    return (
        <View style={styles.actionStyle}>
          <SocialIcon
              ...
              type='plus-circle'
              iconColor='#3faab4'
              onPress={() => Actions.reviewphotoCreate()}
          />
          <SocialIcon
              iconSize={34}
              type='edit'
              iconColor='#3faab4'
              onPress={() => Actions.reviewphotoUpdate({id})}
          />
          <SocialIcon
              iconSize={34}
              type='minus-circle'
...
const mapStateToProps = (state) => {
  return {
    error: state.reviewphoto.show.error,
    loading: state.reviewphoto.show.loading,
    retrieved: state.reviewphoto.show.retrieved,
    deleteError: state.reviewphoto.del.error,
    deleteLoading: state.reviewphoto.del.loading,
