...
import { list, reset } from '../../actions/reviewphoto/list';
import { success } from '../../actions/reviewphoto/delete';
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.reviewphoto.list;
