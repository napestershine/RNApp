...
import { success } from '../../actions/reviewphoto/create';
import { retrieve, update, reset } from '../../actions/reviewphoto/update';
import { loading, error } from '../../actions/reviewphoto/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.reviewphoto.update.retrieveError,
  retrieveLoading: state.reviewphoto.update.retrieveLoading,
  updateError: state.reviewphoto.update.updateError,
  updateLoading: state.reviewphoto.update.updateLoading,
  created: state.reviewphoto.create.created,
  deleted: state.reviewphoto.del.deleted,
  retrieved: state.reviewphoto.update.retrieved,
  updated: state.reviewphoto.update.updated,
});
