...
import { success } from '../../actions/address/delete';
        ...
        <ListItem
            ...
            subtitle={
              <View>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>fullAddress: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['fullAddress']}</Text>
                </View>
                <View style={viewList}>
