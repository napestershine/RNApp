    ...
    return (
      <View style={ {backgroundColor: 'white', paddingBottom: 20} }>
        ...
        <Field component={this.renderField} name="phone" type="text"
          placeholder="" />
        <Field component={this.renderField} name="fullAddress" type="text"
          placeholder="" />
        <Field component={this.renderField} name="user" type="text"
          placeholder="" />
        <Field component={this.renderField} name="foodOrders" type="text"
          placeholder="" />
        <Field component={this.renderField} name="country" type="text"
          placeholder="" />
        <Field component={this.renderField} name="province" type="text"
          placeholder="" />
        <Field component={this.renderField} name="city" type="text"
          placeholder="" />
