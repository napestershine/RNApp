...
import { success } from '../../actions/address/create';
import { retrieve, update, reset } from '../../actions/address/update';
import { loading, error } from '../../actions/address/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.address.update.retrieveError,
  retrieveLoading: state.address.update.retrieveLoading,
  ...
  retrieved: state.address.update.retrieved,
