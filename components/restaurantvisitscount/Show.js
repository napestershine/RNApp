...
import { retrieve, reset } from '../../actions/restaurantvisitscount/show';
import { del, loading, error } from '../../actions/restaurantvisitscount/delete';
import { list } from '../../actions/restaurantvisitscount/list';
    ...
    return (
        <View style={styles.actionStyle}>
          <SocialIcon
              ...
              type='plus-circle'
              iconColor='#3faab4'
              onPress={() => Actions.restaurantvisitscountCreate()}
          />
          <SocialIcon
              iconSize={34}
              type='edit'
              iconColor='#3faab4'
              onPress={() => Actions.restaurantvisitscountUpdate({id})}
          />
          <SocialIcon
              iconSize={34}
              type='minus-circle'
  ...
  render() {
    ...
    return (
        <View style={ {flex: 1} }>
          <ScrollView>
            {item &&
            <Card title="RestaurantVisitsCount">
              <List title="title">
...
const mapStateToProps = (state) => {
  return {
    error: state.restaurantvisitscount.show.error,
    loading: state.restaurantvisitscount.show.loading,
    retrieved: state.restaurantvisitscount.show.retrieved,
    deleteError: state.restaurantvisitscount.del.error,
    deleteLoading: state.restaurantvisitscount.del.loading,
