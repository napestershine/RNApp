...
import { list, reset } from '../../actions/restaurantvisitscount/list';
import { success } from '../../actions/restaurantvisitscount/delete';
...
class ListComponent extends Component {
  ...
  static show(id) {
    Actions.restaurantvisitscountShow({id});
  }
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.restaurantvisitscount.list;
