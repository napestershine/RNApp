...
import { success } from '../../actions/restaurantvisitscount/create';
import { retrieve, update, reset } from '../../actions/restaurantvisitscount/update';
import { loading, error } from '../../actions/restaurantvisitscount/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.restaurantvisitscount.update.retrieveError,
  retrieveLoading: state.restaurantvisitscount.update.retrieveLoading,
  updateError: state.restaurantvisitscount.update.updateError,
  updateLoading: state.restaurantvisitscount.update.updateLoading,
  created: state.restaurantvisitscount.create.created,
  deleted: state.restaurantvisitscount.del.deleted,
  retrieved: state.restaurantvisitscount.update.retrieved,
  updated: state.restaurantvisitscount.update.updated,
});
