...
import { list, reset } from '../../actions/restaurantearningcount/list';
import { success } from '../../actions/restaurantearningcount/delete';
...
class ListComponent extends Component {
  ...
  static show(id) {
    Actions.restaurantearningcountShow({id});
  }
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.restaurantearningcount.list;
