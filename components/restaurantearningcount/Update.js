...
import { success } from '../../actions/restaurantearningcount/create';
import { retrieve, update, reset } from '../../actions/restaurantearningcount/update';
import { loading, error } from '../../actions/restaurantearningcount/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.restaurantearningcount.update.retrieveError,
  retrieveLoading: state.restaurantearningcount.update.retrieveLoading,
  updateError: state.restaurantearningcount.update.updateError,
  updateLoading: state.restaurantearningcount.update.updateLoading,
  created: state.restaurantearningcount.create.created,
  deleted: state.restaurantearningcount.del.deleted,
  retrieved: state.restaurantearningcount.update.retrieved,
  updated: state.restaurantearningcount.update.updated,
});
