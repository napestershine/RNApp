...
import { success } from '../../actions/payment/create';
import { retrieve, update, reset } from '../../actions/payment/update';
import { loading, error } from '../../actions/payment/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.payment.update.retrieveError,
  retrieveLoading: state.payment.update.retrieveLoading,
  updateError: state.payment.update.updateError,
  updateLoading: state.payment.update.updateLoading,
  created: state.payment.create.created,
  deleted: state.payment.del.deleted,
  retrieved: state.payment.update.retrieved,
  updated: state.payment.update.updated,
});
