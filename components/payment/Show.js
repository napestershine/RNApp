...
import { del, loading, error } from '../../actions/payment/delete';
import { list } from '../../actions/payment/list';
    ...
    return (
        <View style={styles.actionStyle}>
          <SocialIcon
              ...
              type='plus-circle'
              iconColor='#3faab4'
              onPress={() => Actions.paymentCreate()}
          />
          <SocialIcon
              iconSize={34}
              type='edit'
              iconColor='#3faab4'
              onPress={() => Actions.paymentUpdate({id})}
          />
          <SocialIcon
              iconSize={34}
              type='minus-circle'
