...
import { retrieve, reset } from '../../actions/contactus/show';
import { del, loading, error } from '../../actions/contactus/delete';
import { list } from '../../actions/contactus/list';
    ...
    return (
        <View style={styles.actionStyle}>
          <SocialIcon
              ...
              type='plus-circle'
              iconColor='#3faab4'
              onPress={() => Actions.contactusCreate()}
          />
          <SocialIcon
              iconSize={34}
              type='edit'
              iconColor='#3faab4'
              onPress={() => Actions.contactusUpdate({id})}
          />
          <SocialIcon
              iconSize={34}
              type='minus-circle'
...
const mapStateToProps = (state) => {
  return {
    error: state.contactus.show.error,
    loading: state.contactus.show.loading,
    retrieved: state.contactus.show.retrieved,
    deleteError: state.contactus.del.error,
    deleteLoading: state.contactus.del.loading,
