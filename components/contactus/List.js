...
import { list, reset } from '../../actions/contactus/list';
import { success } from '../../actions/contactus/delete';
        ...
        <ListItem
            ...
            subtitle={
              <View>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>subject: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['subject']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>message: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['message']}</Text>
                </View>
                <View style={viewList}>
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.contactus.list;
