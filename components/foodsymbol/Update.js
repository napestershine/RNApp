...
import { success } from '../../actions/foodsymbol/create';
import { retrieve, update, reset } from '../../actions/foodsymbol/update';
import { loading, error } from '../../actions/foodsymbol/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.foodsymbol.update.retrieveError,
  retrieveLoading: state.foodsymbol.update.retrieveLoading,
  updateError: state.foodsymbol.update.updateError,
  updateLoading: state.foodsymbol.update.updateLoading,
  created: state.foodsymbol.create.created,
  deleted: state.foodsymbol.del.deleted,
  retrieved: state.foodsymbol.update.retrieved,
  updated: state.foodsymbol.update.updated,
});
