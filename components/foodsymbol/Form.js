    ...
    return (
      <View>
        ...
        <FormInput containerStyle={ {flexDirection:'row'} }
                   ...
                   id={`foodsymbol_${data.input.name}`}
                   multiline={true}
  ...
  render() {
    ...
    return (
      <View style={ {backgroundColor: 'white', paddingBottom: 20} }>
        <Field component={this.renderField} name="mark" type="text"
          placeholder="" />
        <Field component={this.renderField} name="symbol" type="text"
          placeholder="" />
        <Field component={this.renderField} name="foods" type="text"
          placeholder="" />
