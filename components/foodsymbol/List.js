...
import { list, reset } from '../../actions/foodsymbol/list';
import { success } from '../../actions/foodsymbol/delete';
        ...
        <ListItem
            ...
            subtitle={
              <View>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>mark: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['mark']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>symbol: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['symbol']}</Text>
                </View>
                <View style={viewList}>
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.foodsymbol.list;
