...
import { list, reset } from '../../actions/foodcategory/list';
import { success } from '../../actions/foodcategory/delete';
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.foodcategory.list;
