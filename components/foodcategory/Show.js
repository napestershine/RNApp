...
import { retrieve, reset } from '../../actions/foodcategory/show';
import { del, loading, error } from '../../actions/foodcategory/delete';
import { list } from '../../actions/foodcategory/list';
    ...
    return (
        <View style={styles.actionStyle}>
          <SocialIcon
              ...
              type='plus-circle'
              iconColor='#3faab4'
              onPress={() => Actions.foodcategoryCreate()}
          />
          <SocialIcon
              iconSize={34}
              type='edit'
              iconColor='#3faab4'
              onPress={() => Actions.foodcategoryUpdate({id})}
          />
          <SocialIcon
              iconSize={34}
              type='minus-circle'
...
const mapStateToProps = (state) => {
  return {
    error: state.foodcategory.show.error,
    loading: state.foodcategory.show.loading,
    retrieved: state.foodcategory.show.retrieved,
    deleteError: state.foodcategory.del.error,
    deleteLoading: state.foodcategory.del.loading,
