...
import { retrieve, reset } from '../../actions/issue/show';
import { del, loading, error } from '../../actions/issue/delete';
import { list } from '../../actions/issue/list';
    ...
    return (
        <View style={styles.actionStyle}>
          <SocialIcon
              ...
              type='plus-circle'
              iconColor='#3faab4'
              onPress={() => Actions.issueCreate()}
          />
          <SocialIcon
              iconSize={34}
              type='edit'
              iconColor='#3faab4'
              onPress={() => Actions.issueUpdate({id})}
          />
          <SocialIcon
              iconSize={34}
              type='minus-circle'
          ...
          <ScrollView>
            ...
            <Card title="Issue">
              <List title="title">
                ...
                {Show.renderRow('content', item['content'])}
...
const mapStateToProps = (state) => {
  return {
    error: state.issue.show.error,
    loading: state.issue.show.loading,
    retrieved: state.issue.show.retrieved,
    deleteError: state.issue.del.error,
    deleteLoading: state.issue.del.loading,
