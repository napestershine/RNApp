...
import { success } from '../../actions/issue/create';
import { retrieve, update, reset } from '../../actions/issue/update';
import { loading, error } from '../../actions/issue/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.issue.update.retrieveError,
  retrieveLoading: state.issue.update.retrieveLoading,
  updateError: state.issue.update.updateError,
  updateLoading: state.issue.update.updateLoading,
  created: state.issue.create.created,
  deleted: state.issue.del.deleted,
  retrieved: state.issue.update.retrieved,
  updated: state.issue.update.updated,
});
