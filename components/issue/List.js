...
import { list, reset } from '../../actions/issue/list';
import { success } from '../../actions/issue/delete';
        ...
        <ListItem
            ...
            subtitle={
              <View>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>content: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['content']}</Text>
                </View>
                <View style={viewList}>
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.issue.list;
