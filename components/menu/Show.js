...
import { retrieve, reset } from '../../actions/menu/show';
import { del, loading, error } from '../../actions/menu/delete';
import { list } from '../../actions/menu/list';
    ...
    return (
        <View style={styles.actionStyle}>
          <SocialIcon
              ...
              type='plus-circle'
              iconColor='#3faab4'
              onPress={() => Actions.menuCreate()}
          />
          <SocialIcon
              iconSize={34}
              type='edit'
              iconColor='#3faab4'
              onPress={() => Actions.menuUpdate({id})}
          />
          <SocialIcon
              iconSize={34}
              type='minus-circle'
...
const mapStateToProps = (state) => {
  return {
    error: state.menu.show.error,
    loading: state.menu.show.loading,
    retrieved: state.menu.show.retrieved,
    deleteError: state.menu.del.error,
    deleteLoading: state.menu.del.loading,
