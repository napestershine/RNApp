...
import { success } from '../../actions/menu/create';
import { retrieve, update, reset } from '../../actions/menu/update';
import { loading, error } from '../../actions/menu/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.menu.update.retrieveError,
  retrieveLoading: state.menu.update.retrieveLoading,
  updateError: state.menu.update.updateError,
  updateLoading: state.menu.update.updateLoading,
  created: state.menu.create.created,
  deleted: state.menu.del.deleted,
  retrieved: state.menu.update.retrieved,
  updated: state.menu.update.updated,
});
