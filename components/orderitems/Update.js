...
import { success } from '../../actions/orderitems/create';
import { retrieve, update, reset } from '../../actions/orderitems/update';
import { loading, error } from '../../actions/orderitems/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.orderitems.update.retrieveError,
  retrieveLoading: state.orderitems.update.retrieveLoading,
  updateError: state.orderitems.update.updateError,
  updateLoading: state.orderitems.update.updateLoading,
  created: state.orderitems.create.created,
  deleted: state.orderitems.del.deleted,
  retrieved: state.orderitems.update.retrieved,
  updated: state.orderitems.update.updated,
});
