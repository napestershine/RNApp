...
import { list, reset } from '../../actions/orderitems/list';
import { success } from '../../actions/orderitems/delete';
        ...
        <ListItem
            ...
            subtitle={
              <View>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>quantity: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['quantity']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>price: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['price']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>comment: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['comment']}</Text>
                </View>
                <View style={viewList}>
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.orderitems.list;
