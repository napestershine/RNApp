...
import { retrieve, reset } from '../../actions/province/show';
import { del, loading, error } from '../../actions/province/delete';
import { list } from '../../actions/province/list';
    ...
    return (
        <View style={styles.actionStyle}>
          <SocialIcon
              ...
              type='plus-circle'
              iconColor='#3faab4'
              onPress={() => Actions.provinceCreate()}
          />
          <SocialIcon
              iconSize={34}
              type='edit'
              iconColor='#3faab4'
              onPress={() => Actions.provinceUpdate({id})}
          />
          <SocialIcon
              iconSize={34}
              type='minus-circle'
          ...
          <ScrollView>
            ...
            <Card title="Province">
              <List title="title">
                ...
                {Show.renderRow('altName', item['altName'])}
...
const mapStateToProps = (state) => {
  return {
    error: state.province.show.error,
    loading: state.province.show.loading,
    retrieved: state.province.show.retrieved,
    deleteError: state.province.del.error,
    deleteLoading: state.province.del.loading,
    deleted: state.province.del.deleted,
  };
};
