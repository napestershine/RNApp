...
import { list, reset } from '../../actions/province/list';
import { success } from '../../actions/province/delete';
        ...
        <ListItem
            ...
            subtitle={
              <View>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>altName: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['altName']}</Text>
                </View>
                <View style={viewList}>
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.province.list;
