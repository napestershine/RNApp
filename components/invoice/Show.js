...
import { retrieve, reset } from '../../actions/invoice/show';
import { del, loading, error } from '../../actions/invoice/delete';
import { list } from '../../actions/invoice/list';
    ...
    return (
        <View style={styles.actionStyle}>
          <SocialIcon
              ...
              type='plus-circle'
              iconColor='#3faab4'
              onPress={() => Actions.invoiceCreate()}
          />
          <SocialIcon
              iconSize={34}
              type='edit'
              iconColor='#3faab4'
              onPress={() => Actions.invoiceUpdate({id})}
          />
          <SocialIcon
              iconSize={34}
              type='minus-circle'
...
const mapStateToProps = (state) => {
  return {
    error: state.invoice.show.error,
    loading: state.invoice.show.loading,
    retrieved: state.invoice.show.retrieved,
    deleteError: state.invoice.del.error,
    deleteLoading: state.invoice.del.loading,
