...
import { success } from '../../actions/invoice/create';
import { retrieve, update, reset } from '../../actions/invoice/update';
import { loading, error } from '../../actions/invoice/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.invoice.update.retrieveError,
  retrieveLoading: state.invoice.update.retrieveLoading,
  updateError: state.invoice.update.updateError,
  updateLoading: state.invoice.update.updateLoading,
  created: state.invoice.create.created,
  deleted: state.invoice.del.deleted,
  retrieved: state.invoice.update.retrieved,
