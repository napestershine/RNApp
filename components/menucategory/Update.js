...
import { success } from '../../actions/menucategory/create';
import { retrieve, update, reset } from '../../actions/menucategory/update';
import { loading, error } from '../../actions/menucategory/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.menucategory.update.retrieveError,
  retrieveLoading: state.menucategory.update.retrieveLoading,
  updateError: state.menucategory.update.updateError,
  updateLoading: state.menucategory.update.updateLoading,
  created: state.menucategory.create.created,
  deleted: state.menucategory.del.deleted,
  retrieved: state.menucategory.update.retrieved,
  updated: state.menucategory.update.updated,
});
