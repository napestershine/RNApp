    ...
    return (
      <View>
        ...
        <FormInput containerStyle={ {flexDirection:'row'} }
                   ...
                   id={`foodtopping_${data.input.name}`}
                   multiline={true}
    ...
    return (
      <View style={ {backgroundColor: 'white', paddingBottom: 20} }>
        <Field component={this.renderField} name="name" type="text"
          placeholder="" />
        <Field component={this.renderField} name="price" type="text"
          placeholder="" />
        <Field component={this.renderField} name="image" type="text"
          placeholder="" />
        <Field component={this.renderField} name="description" type="text"
          placeholder="" />
        <Field component={this.renderField} name="food" type="text"
          placeholder="" />
