...
import { list, reset } from '../../actions/foodtopping/list';
import { success } from '../../actions/foodtopping/delete';
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.foodtopping.list;
