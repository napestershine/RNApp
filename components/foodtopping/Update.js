...
import { success } from '../../actions/foodtopping/create';
import { retrieve, update, reset } from '../../actions/foodtopping/update';
import { loading, error } from '../../actions/foodtopping/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.foodtopping.update.retrieveError,
  retrieveLoading: state.foodtopping.update.retrieveLoading,
  updateError: state.foodtopping.update.updateError,
  updateLoading: state.foodtopping.update.updateLoading,
  created: state.foodtopping.create.created,
  deleted: state.foodtopping.del.deleted,
  retrieved: state.foodtopping.update.retrieved,
  updated: state.foodtopping.update.updated,
});
