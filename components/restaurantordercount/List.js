...
import { list, reset } from '../../actions/restaurantordercount/list';
import { success } from '../../actions/restaurantordercount/delete';
...
class ListComponent extends Component {
  ...
  static show(id) {
    Actions.restaurantordercountShow({id});
  }
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.restaurantordercount.list;
