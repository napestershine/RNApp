...
import { success } from '../../actions/restaurantordercount/create';
import { retrieve, update, reset } from '../../actions/restaurantordercount/update';
import { loading, error } from '../../actions/restaurantordercount/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.restaurantordercount.update.retrieveError,
  retrieveLoading: state.restaurantordercount.update.retrieveLoading,
  updateError: state.restaurantordercount.update.updateError,
  updateLoading: state.restaurantordercount.update.updateLoading,
  created: state.restaurantordercount.create.created,
  deleted: state.restaurantordercount.del.deleted,
  retrieved: state.restaurantordercount.update.retrieved,
  updated: state.restaurantordercount.update.updated,
});
