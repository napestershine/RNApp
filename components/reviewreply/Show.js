...
import { retrieve, reset } from '../../actions/reviewreply/show';
import { del, loading, error } from '../../actions/reviewreply/delete';
import { list } from '../../actions/reviewreply/list';
    ...
    return (
        <View style={styles.actionStyle}>
          <SocialIcon
              ...
              type='plus-circle'
              iconColor='#3faab4'
              onPress={() => Actions.reviewreplyCreate()}
          />
          <SocialIcon
              iconSize={34}
              type='edit'
              iconColor='#3faab4'
              onPress={() => Actions.reviewreplyUpdate({id})}
          />
          <SocialIcon
              iconSize={34}
              type='minus-circle'
...
const mapStateToProps = (state) => {
  return {
    error: state.reviewreply.show.error,
    loading: state.reviewreply.show.loading,
    retrieved: state.reviewreply.show.retrieved,
    deleteError: state.reviewreply.del.error,
    deleteLoading: state.reviewreply.del.loading,
