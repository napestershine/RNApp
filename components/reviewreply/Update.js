...
import { success } from '../../actions/reviewreply/create';
import { retrieve, update, reset } from '../../actions/reviewreply/update';
import { loading, error } from '../../actions/reviewreply/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.reviewreply.update.retrieveError,
  retrieveLoading: state.reviewreply.update.retrieveLoading,
  updateError: state.reviewreply.update.updateError,
  updateLoading: state.reviewreply.update.updateLoading,
  created: state.reviewreply.create.created,
  deleted: state.reviewreply.del.deleted,
  retrieved: state.reviewreply.update.retrieved,
  updated: state.reviewreply.update.updated,
});
