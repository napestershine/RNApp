...
import { list, reset } from '../../actions/reviewreply/list';
import { success } from '../../actions/reviewreply/delete';
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.reviewreply.list;
