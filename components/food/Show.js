...
import { retrieve, reset } from '../../actions/food/show';
import { del, loading, error } from '../../actions/food/delete';
import { list } from '../../actions/food/list';
    ...
    return (
        <View style={styles.actionStyle}>
          <SocialIcon
              ...
              type='plus-circle'
              iconColor='#3faab4'
              onPress={() => Actions.foodCreate()}
          />
          <SocialIcon
              iconSize={34}
              type='edit'
              iconColor='#3faab4'
              onPress={() => Actions.foodUpdate({id})}
          />
          <SocialIcon
              iconSize={34}
              type='minus-circle'
...
const mapStateToProps = (state) => {
  return {
    error: state.food.show.error,
    loading: state.food.show.loading,
    retrieved: state.food.show.retrieved,
    deleteError: state.food.del.error,
    deleteLoading: state.food.del.loading,
