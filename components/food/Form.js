    ...
    return (
      <View style={ {backgroundColor: 'white', paddingBottom: 20} }>
        ...
        <Field component={this.renderField} name="description" type="text"
          placeholder="" />
        <Field component={this.renderField} name="price" type="number"
          placeholder="" />
        <Field component={this.renderField} name="foodCategory" type="text"
          placeholder="" />
        <Field component={this.renderField} name="foodSymbol" type="text"
          placeholder="" />
        <Field component={this.renderField} name="foodToppings" type="text"
          placeholder="" />
