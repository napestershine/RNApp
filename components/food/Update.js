...
import { success } from '../../actions/food/create';
import { retrieve, update, reset } from '../../actions/food/update';
import { loading, error } from '../../actions/food/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.food.update.retrieveError,
  retrieveLoading: state.food.update.retrieveLoading,
  updateError: state.food.update.updateError,
  updateLoading: state.food.update.updateLoading,
  created: state.food.create.created,
  deleted: state.food.del.deleted,
  retrieved: state.food.update.retrieved,
  updated: state.food.update.updated,
});
