...
import { retrieve, reset } from '../../actions/reservation/show';
import { del, loading, error } from '../../actions/reservation/delete';
import { list } from '../../actions/reservation/list';
    ...
    return (
        <View style={styles.actionStyle}>
          <SocialIcon
              ...
              type='plus-circle'
              iconColor='#3faab4'
              onPress={() => Actions.reservationCreate()}
          />
          <SocialIcon
              iconSize={34}
              type='edit'
              iconColor='#3faab4'
              onPress={() => Actions.reservationUpdate({id})}
          />
          <SocialIcon
              iconSize={34}
              type='minus-circle'
...
const mapStateToProps = (state) => {
  return {
    error: state.reservation.show.error,
    loading: state.reservation.show.loading,
    retrieved: state.reservation.show.retrieved,
