...
import { success } from '../../actions/faq/create';
import { retrieve, update, reset } from '../../actions/faq/update';
import { loading, error } from '../../actions/faq/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.faq.update.retrieveError,
  retrieveLoading: state.faq.update.retrieveLoading,
  updateError: state.faq.update.updateError,
  updateLoading: state.faq.update.updateLoading,
  created: state.faq.create.created,
  deleted: state.faq.del.deleted,
  retrieved: state.faq.update.retrieved,
  updated: state.faq.update.updated,
});
