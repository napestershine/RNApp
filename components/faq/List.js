...
import { list, reset } from '../../actions/faq/list';
import { success } from '../../actions/faq/delete';
        ...
        <ListItem
            ...
            subtitle={
              <View>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>question: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['question']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>answer: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['answer']}</Text>
                </View>
                <View style={viewList}>
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.faq.list;
