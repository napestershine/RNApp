...
import { retrieve, reset } from '../../actions/faq/show';
import { del, loading, error } from '../../actions/faq/delete';
import { list } from '../../actions/faq/list';
    ...
    return (
        <View style={styles.actionStyle}>
          <SocialIcon
              ...
              type='plus-circle'
              iconColor='#3faab4'
              onPress={() => Actions.faqCreate()}
          />
          <SocialIcon
              iconSize={34}
              type='edit'
              iconColor='#3faab4'
              onPress={() => Actions.faqUpdate({id})}
          />
          <SocialIcon
              iconSize={34}
              type='minus-circle'
          ...
          <ScrollView>
            ...
            <Card title="Faq">
              <List title="title">
                ...
                {Show.renderRow('question', item['question'])}
                {Show.renderRow('answer', item['answer'])}
...
const mapStateToProps = (state) => {
  return {
    error: state.faq.show.error,
    loading: state.faq.show.loading,
    retrieved: state.faq.show.retrieved,
    deleteError: state.faq.del.error,
    deleteLoading: state.faq.del.loading,
