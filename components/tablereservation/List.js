...
import { list, reset } from '../../actions/tablereservation/list';
import { success } from '../../actions/tablereservation/delete';
...
class ListComponent extends Component {
  ...
  static show(id) {
    Actions.tablereservationShow({id});
  }
        ...
        <ListItem
            ...
            subtitle={
              <View>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>tableNumber: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['tableNumber']}</Text>
                </View>
                <View style={viewList}>
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.tablereservation.list;
