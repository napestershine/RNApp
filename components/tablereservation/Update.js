...
import { success } from '../../actions/tablereservation/create';
import { retrieve, update, reset } from '../../actions/tablereservation/update';
import { loading, error } from '../../actions/tablereservation/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.tablereservation.update.retrieveError,
  retrieveLoading: state.tablereservation.update.retrieveLoading,
  updateError: state.tablereservation.update.updateError,
  updateLoading: state.tablereservation.update.updateLoading,
  created: state.tablereservation.create.created,
  deleted: state.tablereservation.del.deleted,
  retrieved: state.tablereservation.update.retrieved,
  updated: state.tablereservation.update.updated,
});
