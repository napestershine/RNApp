...
import { list, reset } from '../../actions/verificationcode/list';
import { success } from '../../actions/verificationcode/delete';
...
class ListComponent extends Component {
  ...
  static show(id) {
    Actions.verificationcodeShow({id});
  }
        ...
        <ListItem
            ...
            subtitle={
              <View>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>userId: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['userId']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>channel: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['channel']}</Text>
                </View>
                <View style={viewList}>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>code: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['code']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>verifyingTimes: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['verifyingTimes']}</Text>
                </View>
                <View style={viewList}>
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.verificationcode.list;
