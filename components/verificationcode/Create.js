...
import { create, loading, error, reset } from '../../actions/verificationcode/create';
...
const mapStateToProps = state => {
  const {created, error, loading} = state.verificationcode.create;
