    ...
    return (
      <View>
        ...
        <FormInput containerStyle={ {flexDirection:'row'} }
                   ...
                   id={`verificationcode_${data.input.name}`}
                   multiline={true}
  ...
  render() {
    ...
    return (
      <View style={ {backgroundColor: 'white', paddingBottom: 20} }>
        <Field component={this.renderField} name="userId" type="number"
          placeholder="" />
        <Field component={this.renderField} name="channel" type="text"
          placeholder="" />
        <Field component={this.renderField} name="phone" type="text"
          placeholder="" />
        <Field component={this.renderField} name="code" type="text"
          placeholder="" />
        <Field component={this.renderField} name="verifyingTimes" type="text"
          placeholder="" />
