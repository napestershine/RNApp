...
import { success } from '../../actions/verificationcode/create';
import { retrieve, update, reset } from '../../actions/verificationcode/update';
import { loading, error } from '../../actions/verificationcode/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.verificationcode.update.retrieveError,
  retrieveLoading: state.verificationcode.update.retrieveLoading,
  updateError: state.verificationcode.update.updateError,
  updateLoading: state.verificationcode.update.updateLoading,
  created: state.verificationcode.create.created,
  deleted: state.verificationcode.del.deleted,
  retrieved: state.verificationcode.update.retrieved,
  updated: state.verificationcode.update.updated,
});
