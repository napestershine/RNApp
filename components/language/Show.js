...
import { retrieve, reset } from '../../actions/language/show';
import { del, loading, error } from '../../actions/language/delete';
import { list } from '../../actions/language/list';
    ...
    return (
        <View style={styles.actionStyle}>
          <SocialIcon
              ...
              type='plus-circle'
              iconColor='#3faab4'
              onPress={() => Actions.languageCreate()}
          />
          <SocialIcon
              iconSize={34}
              type='edit'
              iconColor='#3faab4'
              onPress={() => Actions.languageUpdate({id})}
          />
          <SocialIcon
              iconSize={34}
              type='minus-circle'
...
const mapStateToProps = (state) => {
  return {
    error: state.language.show.error,
    loading: state.language.show.loading,
    retrieved: state.language.show.retrieved,
    deleteError: state.language.del.error,
    deleteLoading: state.language.del.loading,
