...
import { list, reset } from '../../actions/language/list';
import { success } from '../../actions/language/delete';
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.language.list;
