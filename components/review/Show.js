...
import { list } from '../../actions/review/list';
    ...
    return (
        <View style={styles.actionStyle}>
          <SocialIcon
              ...
              type='plus-circle'
              iconColor='#3faab4'
              onPress={() => Actions.reviewCreate()}
          />
          <SocialIcon
              iconSize={34}
              type='edit'
              iconColor='#3faab4'
              onPress={() => Actions.reviewUpdate({id})}
          />
          <SocialIcon
              iconSize={34}
              type='minus-circle'
          ...
          <ScrollView>
            ...
            <Card title="Review">
              <List title="title">
                ...
                {Show.renderRow('restaurantId', item['restaurantId'])}
                {Show.renderRow('orderId', item['orderId'])}
                {Show.renderRow('body', item['body'])}
                {Show.renderRow('rating', item['rating'])}
