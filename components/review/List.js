        ...
        <ListItem
            ...
            subtitle={
              <View>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>restaurantId: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['restaurantId']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>orderId: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['orderId']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>body: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['body']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>rating: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['rating']}</Text>
                </View>
                <View style={viewList}>
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.review.list;
