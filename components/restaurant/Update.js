...
import { success } from '../../actions/restaurant/create';
import { retrieve, update, reset } from '../../actions/restaurant/update';
import { loading, error } from '../../actions/restaurant/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.restaurant.update.retrieveError,
  retrieveLoading: state.restaurant.update.retrieveLoading,
  updateError: state.restaurant.update.updateError,
  updateLoading: state.restaurant.update.updateLoading,
  created: state.restaurant.create.created,
  deleted: state.restaurant.del.deleted,
  retrieved: state.restaurant.update.retrieved,
  updated: state.restaurant.update.updated,
});
