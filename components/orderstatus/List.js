...
import { list, reset } from '../../actions/orderstatus/list';
import { success } from '../../actions/orderstatus/delete';
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.orderstatus.list;
