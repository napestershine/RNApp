...
import { success } from '../../actions/orderstatus/create';
import { retrieve, update, reset } from '../../actions/orderstatus/update';
import { loading, error } from '../../actions/orderstatus/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.orderstatus.update.retrieveError,
  retrieveLoading: state.orderstatus.update.retrieveLoading,
  updateError: state.orderstatus.update.updateError,
  updateLoading: state.orderstatus.update.updateLoading,
  created: state.orderstatus.create.created,
  deleted: state.orderstatus.del.deleted,
  retrieved: state.orderstatus.update.retrieved,
  updated: state.orderstatus.update.updated,
});
