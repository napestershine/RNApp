...
import { retrieve, reset } from '../../actions/orderstatus/show';
import { del, loading, error } from '../../actions/orderstatus/delete';
import { list } from '../../actions/orderstatus/list';
    ...
    return (
        <View style={styles.actionStyle}>
          <SocialIcon
              ...
              type='plus-circle'
              iconColor='#3faab4'
              onPress={() => Actions.orderstatusCreate()}
          />
          <SocialIcon
              iconSize={34}
              type='edit'
              iconColor='#3faab4'
              onPress={() => Actions.orderstatusUpdate({id})}
          />
          <SocialIcon
              iconSize={34}
              type='minus-circle'
...
const mapStateToProps = (state) => {
  return {
    error: state.orderstatus.show.error,
    loading: state.orderstatus.show.loading,
    retrieved: state.orderstatus.show.retrieved,
    deleteError: state.orderstatus.del.error,
    deleteLoading: state.orderstatus.del.loading,
